...
void loop() {
  ...
  if(state==1){
    stepperFront.changeRPM(60);
    stepperRight.changeRPM(-120);
    stepperLeft.changeRPM(60);
  ...
  {
    stepperFront.changeRPM(60);
    stepperRight.changeRPM(60);
    stepperLeft.changeRPM(-120);
